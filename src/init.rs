...
use vulkano::{
    ...
    }, instance::{Instance, InstanceCreateFlags, InstanceCreateInfo}, memory::allocator::{AllocationCreateInfo, MemoryTypeFilter, StandardMemoryAllocator}, swapchain::Surface, sync::GpuFuture, VulkanLibrary
};
use winit::event_loop::EventLoop;

use crate::model::load_viking_room_model;
...
pub struct InitializedVulkan {
    ...
    pub model_buffers: crate::model::VikingRoomModelBuffers,
